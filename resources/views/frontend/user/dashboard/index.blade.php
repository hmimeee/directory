    ...
    <div class="tz-2-com tz-2-main">
        ...
        <div class="tz-2-main-com">
            <div class="tz-2-main-1">
                <div class="tz-2-main-2"> <img src="{{ asset('images/icon/d1.png') }}" alt="" /><span>All Listings</span>
                    <p>Total no of listings</p>
                    <h2>04</h2> </div>
            </div>
            <div class="tz-2-main-1">
                <div class="tz-2-main-2"> <img src="{{ asset('images/icon/d2.png') }}" alt="" /><span>Review</span>
                    <p>Total no of reviews</p>
                    <h2>69</h2> </div>
            </div>
            <div class="tz-2-main-1">
                <div class="tz-2-main-2"> <img src="{{ asset('images/icon/d3.png') }}" alt="" /><span>Messages</span>
        ...
        <div class="db-list-com tz-db-table">
            ...
            <div class="tz-mess">
                <ul>
                    <li class="view-msg">
                        <h5><img src="{{ asset('images/users/1.png') }}" alt="" />Listing Enquiry <span class="tz-msg-un-read">unread</span></h5>
                    ...
                    <li class="view-msg">
                        <h5><img src="{{ asset('images/users/4.png') }}" alt="" />Request for meet <span class="tz-msg-read">unread</span></h5>
        ...
        <div class="db-list-com tz-db-table">
            ...
            <div class="tz-mess">
                <ul>
                    <li class="view-msg">
                        <h5><img src="{{ asset('images/users/1.png') }}" alt="" />Jessica <span class="tz-revi-star"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></span></h5>
                    ...
                    <li class="view-msg">
                        <h5><img src="{{ asset('images/users/1.png') }}" alt="" />	Christopher <span class="tz-revi-star"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></span></h5>
                        <p>Duis nulla ligula, interdum porta nulla sed, efficitur tempus lacus. Quisque facilisis, sapien tempor mollis sollicitudin, urna ligula vulputate nulla, rhoncus faucibus justo mauris eget elit.Pellentesque eget pellentesque dolor.</p>
                        <div class="hid-msg"><a href="#!"><i class="fa fa-check" title="approve this review"></i></a><a href="#!"><i class="fa fa-edit" title="edit"></i></a><a href="#!"><i class="fa fa-trash" title="delete"></i></a><a href="#!"><i class="fa fa-reply edit-replay" title="replay"></i></a>
                            <form class="col s12 hide-box">
                                <div class="">
