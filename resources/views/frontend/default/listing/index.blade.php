					...
					<div class="col-md-3 dir-alp-con-left">
						...
						<div class="dir-hom-pre dir-alp-left-ner-notb">
							<ul>
								<!--==========NEARBY LISTINGS============-->
								<li>
									<a href="{{ route('listings.show','slug') }}">
						...
						<div class="dir-alp-con-right-1">
							<div class="row">
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Property Luxury Homes</h3></a>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Effi Furniture Dealers</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>NIID Job Training</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Computer Repair & Services</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Packers and Movers</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Tour and Travels</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Andru Modular Kitchen</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Rute Skin Care & Treatment</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
								...
								<div class="home-list-pop list-spac list-spac-1">
									...
									<div class="col-md-3"> <img src="images/services/s6.jpg" alt="" /> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc"> <a href="{{ route('listings.show','slug') }}"><h3>Health and Fitness</h3></a>
										<h4>Express Avenue Mall, Los Angeles</h4>
										<p><b>Address:</b> 28800 Orchard Lake Road, Suite 180 Farmington Hills, U.S.A.</p>
										<div class="list-number">
											<ul>
